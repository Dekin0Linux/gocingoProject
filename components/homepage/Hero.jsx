    ...
    <section className="max-w-8xl  container mx-auto ">
      <div className="flex justify-center p-10">
        <div className="text-center lg:w-1/2 animate__animated animate__fadeInUp">
          ...
          <p className="my-5 lg:my-10 font-medium sm:text-lg lg:text-xl text-gray-500">The world's largest social fundraising platform, optimized for your charity in a more easy way</p>
